...
def is_latex_equal(
    given_answer: str, ground_truth: str, math_mode="math_verify"
) -> bool:
    if math_mode == "legacy":
        ...
        try:
            with timeout(seconds=1):
                return _is_latex_equal(ground_truth, given_answer)
        except TimeoutError:
            return False
...
def grade_answer(solution_str, ground_truth):
    ...
    if given_answer is None:
        return False
    return is_value_equal(given_answer, ground_truth) or is_latex_equal(
...
def grade(model_answer: str, gt_answer: str):
    ...
    return (
        grade_answer_mathd(model_answer, gt_answer)
        or grade_answer_sympy(model_answer, gt_answer)
        or is_latex_equal(
            model_answer,
            gt_answer,
        )
